        ...
        <body className='bg-white max-w-lg mx-auto rounded-lg p-10'>
            ...
            <form className='flex flex-col' autoComplete='off'>
                <div className='relative my-4 bg-white rounded-md border-2 border-gray-300 focus-within:border-sky-500'>
                    <input className='block pb-4 px-3 pt-6 w-full text-md appearance-none focus:outline-none bg-transparent bg-white rounded-md text-gray-600' placeholder=" "  type="email" name="email" id="email" />
                    <label className='absolute top-0 text-md pb-4 px-3 pt-5 -zIndex-1 duration-300 origin-0 rounded text-gray-600 font-bold' for="email">Email</label>
                </div>

                <div className='relative my-4 bg-white rounded-md border-2 border-gray-300 focus-within:border-sky-500'>
                    <input className='block pb-4 px-3 pt-6 w-full text-md appearance-none focus:outline-none bg-transparent bg-white rounded-md text-gray-600' placeholder=" "  type="password" name="password" id="password" />
                    <label className='absolute top-0 text-md pb-4 px-3 pt-5 -zIndex-1 duration-300 origin-0 rounded text-gray-600 font-bold' for="password">Password</label>
                </div>
